...
import { signInWithGoogle } from "../giris/actions";

const s = {
  wrap: { minHeight: "100vh", background: "#090909", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" } as const,
  card: { width: "100%", maxWidth: 420, background: "#111", border: "1px solid #222", borderRadius: 12, padding: "40px 32px" } as const,
    ...
    return (
      <div style={s.wrap}>
        <div style={s.card}>
          ...
          <div style={s.success}>
            <strong>E-postanızı doğrulayın</strong><br />
            Kayıt başarılı. Gönderilen doğrulama bağlantısına tıklayarak hesabınızı aktifleştirin.
          </div>
  ...
  return (
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        <h1 style={s.title}>Hesap Oluştur</h1>
        <p style={s.sub}>Ücretsiz kayıt olun</p>
        ...
        <form action={action}>
          ...
          <div style={s.fieldWrap}>
            ...
            <input style={s.input} id="full_name" name="full_name" type="text" required autoComplete="name" placeholder="Ahmet Yılmaz" />
          </div>
          ...
          <div style={s.fieldWrap}>
            ...
            <input style={s.input} id="phone" name="phone" type="tel" autoComplete="tel" placeholder="05XX XXX XX XX" />
          </div>
        ...
        <p style={s.footer}>
          ...
          <Link href={`/giris${next ? `?next=${encodeURIComponent(next)}` : ""}`} style={s.link}>
            Giriş Yap
          </Link>
        </p>
      </div>
